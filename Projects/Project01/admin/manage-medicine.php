              ...
              <table class="table datatable table-hover table-stripped ">
                ...
                ?>
                  <tr>
                    ...
                    <!-- <td class="text-center"><a title="View patient" href="medicine-edit.php?id=<?php echo $row['MedicineID']; ?>" ><i class="bi bi-eye-fill text-success "></i></a> </td>
                    <td class="text-center"><a title="View patient" href="medicine-edit.php?id=<?php echo $row['MedicineID']; ?>" ><i class="bi bi-trash-fill text-danger "></i></a> </td> -->
