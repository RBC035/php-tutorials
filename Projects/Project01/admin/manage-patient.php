              ...
              <table class="table datatable table-hover table-stripped ">
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center"><a title="Delete patient" href="patient-handler.php?en=<?php echo $row['PatientID'];  ?>" onclick="return confirm('Are you sure want to disable or enable this patient..?')">
                      <?php 
                        if ($row['status'] == 'Enable') 
                        {
                     ?>
